...
public final class ForkEntrypoint implements ModInitializer {
    ...
    private static int help(CommandSourceStack source) {
        source.sendSuccess(() -> Component.literal("FORK | start fixture/live | power clinic/workshop | advance | retry | cancel | rewind | inspect | compare | demolish"), false); return 1;
    }
