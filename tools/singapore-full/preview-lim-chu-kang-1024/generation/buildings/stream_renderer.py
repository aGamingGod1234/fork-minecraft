...
def main():
    ...
    if source.get("type") != "FeatureCollection":
        raise ValueError("Input must be a complete projected building FeatureCollection")
    result=render_stream(source["features"],tuple(args.tile),args.output,args.manifest,
